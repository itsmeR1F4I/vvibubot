...
const cekafk = (_dir) => {
    setInterval(() => {
		...
		const ovo = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE OVO 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/pemuda.jpg'),sourceUrl:"https://bit.ly/3C2F9Cc"}}})
		}
		const dana = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE DANA 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/pemuda.jpg'),sourceUrl:"https://bit.ly/3C2F9Cc"}}})
		}
		const gopay = (teks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "📲 QRCODE GOPAY 📲",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/pemuda.jpg'),sourceUrl:"https://bit.ly/3C2F9Cc"}}})
		}
...
const isAntiVO = isGroup ? antiviewonce.includes(from) : false	
		...
		const katalog = (teks) => {
             res = pemuda.prepareMessageFromContent(from,{ "orderMessage": { "itemCount": 321, "message": teks, "footerText": "© Rifai Chanel", "thumbnail": ofrply, "surface": 'CATALOG' }}, {quoted:ftrol})
             pemuda.relayWAMessage(res)
        }
        const grupinv = (teks) => {
        	grup = pemuda.prepareMessageFromContent(from, { "groupInviteMessage": { "groupJid": '', "inviteCode": 'https://chat.whatsapp.com/', "groupName": `${NamaBot}`, "footerText": "© Rifai Chanel", "jpegThumbnail": ofrply, "caption": teks}}, {quoted:finv})
...
const sendreply = (from, teks, faketeks) => {
				pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})}, message: { orderMessage: { itemCount: 0000000000, status: 200, thumbnail: fs.readFileSync('./media/image/pemuda.jpg'), surface: 200, message: `Rifai Botz`, orderTitle: `Rifai Chanel`, sellerJid: '0@s.whatsapp.net'}}}, contextInfo: { forwardingScore: 508, isForwarded: true }})
	...
	//•======>> SUBSCRIBE : Rifai CHANEL <<====•\\
        ...
        const sendWebp = async(from, url) => {
	        ...
	        pemuda.sendMessage(from, { disname: nama, vcard: vcard}, MessageType.contact, {contextInfo: {"mentionedJid": ane}})
				...
				const reply = (teks) => {
			pemuda.sendMessage(from, teks, text, { thumbnail: dfrply, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title:`Hai ${pushname}`,body:"",previewType:"PHOTO",thumbnail:ofrply,sourceUrl:`https://wa.me/6287834324804?text=Assalamualaikum%20Kakak%20Chandra%20yang%20Ganteng`}}})
		}
		const simir = (teks) => {
...
pemuda.updatePresence(from, Presence.recording)
  ...
  case 'allmenu':
        ptod = "6287834324804@s.whatsapp.net"
        stod = `${sender}`
        uwu = '```'
       stst = await pemuda.getStatus(`${sender.split('@')[0]}@c.us`)
				stst = stst.status == 401 ? '' : stst.status
tescok = `${menunya(prefix)}`
Sendbutdocument(from, tescok, "© Rifai Botz*", fs.readFileSync('./media/RifaiGG.pdf'), {mimetype:Mimetype.pdf, thumbnail:fs.readFileSync('./media/image/thumbnaildokumen.jpg'), filename:`RifaiGG.pdf`, pageCount: 999999999 }, [{buttonId:`!owner`,buttonText:{displayText:'OWNER'},type:1}], {quoted:fvid, contextInfo: { mentionedJid: [dtod,otod,stod], forwardingScore: 508, isForwarded: true, externalAdReply:{title:`${tampilUcapan} - ${pushname}\nDownload Script`,mediaType:"2",thumbnail:ofrply,mediaUrl:`https://youtu.be/x-O0WHkv3uc`}}})
break
case 'menu':
case 'help':
stod = `${sender}`
...
❅email : Rifaigans73@gmail.com
❅Charged : ${baterai.isCharge}
❅Mode ','͊͊͊͊͋͋͋͋͋͋͋͋͋͋͋: ${publik ? 'public' : 'self'}
❅Prefix : ${multi ? 'Multi Prefix' : 'No Prefix'}`,
 buttonText: '⚘𝔖𝔦𝔩𝔞𝔥𝔨𝔞𝔫 𝔭𝔦𝔩𝔦𝔥 𝔪𝔢𝔫𝔲 𝔡𝔦𝔰𝔦𝔫𝔦⚘',
 footerText: '© Rifai Botzོ',
 description: `❁「 User Info 」 ❁
❅Status : ${isOwner ? 'Owner' : 'User'}
❅Namaཷ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ึ͓̽ࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧࣧ: ${pushname}
❅Bio : ${stst}
❅Nomor : @${stod.split('@')[0]}`,
 sections: [
                     {
...
case 'sewa':
       ...
       menu = `0`
sendButLocation(from, `*_Hai ${pushname} 👋🏻_* \n\nyakin nih mau sewa bot ? 🤔 Boong auto banned >_<`, "*Rifai Bot © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa1`,buttonText:{displayText:'🗿Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'sewa1':
 listMsg = {
 buttonText: 'KLIK DISINI',
 footerText: '*Rifai Botz © 2021*',
...
case '🕔sewa':
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*Rifai Botz © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}py`,buttonText:{displayText:'NOMOR 📱'},type:1},{buttonId:`${prefix}qrsewa`,buttonText:{displayText:'QR CODE 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'py':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_*Hai ${pushname}🌹*_\n\nSilahkan pilih metode pembayaran`, "*Rifai Botz © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}o1`,buttonText:{displayText:'OVO 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'GOPAY 📱'},type:1},{buttonId:`${prefix}d1`,buttonText:{displayText:'DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qrsewa':
        case '0':
        stod = `${sender}`
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}🌹_\n\nSilahkan pilih metode pembayaran`, "*Rifai Botz © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}qrg1`,buttonText:{displayText:'QR GOPAY 📱'},type:1},{buttonId:`${prefix}qro1`,buttonText:{displayText:'QR OVO 📱'},type:1},{buttonId:`${prefix}qrd1`,buttonText:{displayText:'QR DANA 📱'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
case 'qro1':
...
case 'sewaff2':
       ...
       menu = `0`
sendButLocation(from, `_Hai ${pushname}_\n\nSilahkan pilih metode pembayaran`, "Rifai Botz © 2021*", {jpegThumbnail:ofrply}, [{buttonId:`${prefix}sewa2`,buttonText:{displayText:'💞Ya'},type:1},{buttonId:`${prefix}gk`,buttonText:{displayText:'👀Tidak'},type:1}], {contextInfo: { mentionedJid: [dtod,otod,stod]}})
break
///===== PEMBATAS SEWA ====\\\
//// PEMBATAS MENU OWNER \\\
case 'ban':
...
case 'bc':
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						buff = await pemuda.downloadMediaMessage(encmedia)
						for (let _ of anu) {
							pemuda.sendMessage(_.jid, buff, video, { mimetype: Mimetype.gif, quoted: finv, contextInfo: { forwardingScore: 50578, isForwarded: true}, caption: `${body.slice(4)}` })
						}
						reply(`Sukses mengirim Broadcast ${body.slice(4)}`)
					} else {
						for (let _ of anu) {
...
const btnbc = {
    ...
    footerText: 'Broadcast Rifai Botz © 2021',
    buttons: buttons,
    headerType: 1
}
...
client.browserDescription = ['Rifai Botz','Desktop','3.0']
...
case 'maker2d2': 
		...
		case 'maker2d4': 
			...
			case 'transformer': 
					...
					break
               case 'googletxt':
                  if (args.length < 1) return reply(`*Example :*\n${prefix}${command} Rifai CHANEL|chan|kawai`)
             makell = args.join(" ")
             ll1 = makell.split("|")[0];
             ll2 = makell.split("|")[1];
             ll3 = makell.split("|")[0];
...
- Hari : ${week} ${weton}
- Tanggal : ${calender}`
sendButLocation(from,  `${menu}`, `${uwu}© Rifai Chanel ${uwu}`, {jpegThumbnail:ofrply}, [{buttonId:`${prefix}script`,buttonText:{displayText:'SCRIPT🔥'},type:1}, {buttonId:`${prefix}ofc`,buttonText:{displayText:'GRUP OFFICIAL👥'},type:1}], {contextInfo: { mentionedJid: [ptod,dtod,otod,stod]}})
break
case 'script2': case 'sc2': case 'esce2': case 'source2':
 pemuda.sendMessage(from,`: ╰(◣﹏◢)╯\
Script ${NamaBot} :
• No yt
`, text, { thumbnail: dfrply , sendEphemeral: true,contextInfo: { mentionedJid: mem,forwardingScore: 584608, isForwarded: true, externalAdReply:{title: "𝕾𝖚𝖇𝖘𝖈𝖗𝖎𝖇𝖊 RifaiGG",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Rifai.jpg'),sourceUrl:"No yt"}}, quoted: fvid})


		break
case 'partnerbot':
		pemuda.sendMessage(from, `*Partner BOT Rifai*\n\n- Bot Rifai :\nhttps://wa.me/6287834324804?text=Hai%20kak`, text, { thumbnail: dfrply, sendEphemeral: true, quoted: fvid, contextInfo: { forwardingScore: 507388, isForwarded: true, externalAdReply:{title: "𝕾𝖚𝖇𝖘𝖈𝖗𝖎𝖇𝖊 RifaiGG",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Rifai.jpg'),sourceUrl:"No yt"}}})
		break
...
Script ${NamaBot} :
• No yt
`, text, { thumbnail: dfrply , sendEphemeral: true,contextInfo: { mentionedJid: mem,forwardingScore: 508, isForwarded: true, externalAdReply:{title: "𝕾𝖚𝖇𝖘𝖈𝖗𝖎𝖇𝖊 RifaiGG",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/Rifai.jpg'),sourceUrl:"No yt"}}, quoted: fvid})
...
const kontil = body.slice(8)
                    ...
                    pemuda.sendMessage('6287834324804@s.whatsapp.net', options, text, {quoted: mek})
...
break
		case 'instainfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Instagram Pemilik Bot, Jangan Lupa Follow yak😉\n\nhttps://instagram.com/cal_me_Rifai", matchedText: 'https://instagram.com/cal_me_Rifai', description: "", title: "KLIK UNTUK FOLLOW", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'youtubeinfo':
		pemuda.sendMessage(from, { text: "Hai kak Nih Youtube Pemilik Bot, Jangan Lupa Subcribe yak😉\n\nNo yt", matchedText: 'No yt', description: "", title: "KLIK UNTUK SUBCRIBE", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'isi':
		pemuda.sendMessage(from, { text: "𝑆𝑖𝑙𝑎ℎ𝑘𝑎𝑛 𝐼𝑠𝑖 𝐷𝑎𝑡𝑎 𝑃𝑒𝑚𝑏𝑒𝑙𝑖𝑎𝑛\n👤Nama:\n📎Id:\n💎Jumblah Diamond:\n💸Metode Pembayaran:\nSilahkan Salin Atau Screenshot Jika Sudah Mengisi Terus kirim Ke Owner", matchedText: 'No yt', description: "", title: "𝕾𝖚𝖇𝖘𝖈𝖗𝖎𝖇𝖊 RifaiGG", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
		case 'isi2':
		pemuda.sendMessage(from, { text: "𝑆𝑖𝑙𝑎ℎ𝑘𝑎𝑛 𝐼𝑠𝑖 𝐷𝑎𝑡𝑎 𝑃𝑒𝑚𝑏𝑒𝑙𝑖𝑎𝑛\n👤Nama:\n📎Id Dan Server:\n💎Jumblah Diamond:\n💸Metode Pembayaran:\nSilahkan Salin Atau Screenshot Jika Sudah Mengisi Terus kirim Ke Owner", matchedText: 'No yt', description: "", title: "𝕾𝖚𝖇𝖘𝖈𝖗𝖎𝖇𝖊 RifaiGG", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: true, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'partnerbot':
		pemuda.sendMessage(from, { text: "*Partner BOT Rifai Chanel*\n\n- Bot Rifai :\nhttps://wa.me/6287834324804?text=.menu\nThanks Udah Makek Bot ini😉", matchedText: 'No yt', description: "", title: "Yang klik Anak Haram", jpegThumbnail: ofrply }, 'extendedTextMessage', { detectLinks: false, contextInfo: { forwardingScore: 508, isForwarded: true}, quoted: finv})
		break
case 'speed':
               case 'ping':
...
Giliran = @${tty.er1.split('@')[0]}`
 ...
 //•======>> SUBSCRIBE : Rifai CHANEL <<====•\\
     ...
     pemuda.sendMessage(`${settings.NomorOwner}@s.whatsapp.net`, `─────「 *ALERT-ERROR* 」─────\n\n\`\`\`${e}\`\`\`\n\n────────────────────`, MessageType.text, {contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: "Developer Rifai Botz",body:"",previewType:"PHOTO",thumbnail:fs.readFileSync('./media/image/pemuda.jpg'),sourceUrl:"https://youtu.be/x-O0WHkv3uc"}}})
	}
    }
    }
    }
